...
Before we continue on to the lexicon let's analyse the middle constructions in example~\pref{middles}
because this will be the basis for the rules in our parser.
...
just illustrate the structure with a diagram, i.e. and RRG tree.
