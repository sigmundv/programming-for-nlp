...
\lstinputlisting[caption={An RRG parser for middle constructions
                             in Faroese implemented in Python.},
                             label={parser}]{code/parse.py}
...
\lstinputlisting[caption={The sentences used to test the parser},label=sentences]{code/sentences.txt}
...
\lstinputlisting[caption={The ungrammatical sentences used to test the parser},label=sentences_ungrammatical]{code/sentences_ungrammatical.txt}
